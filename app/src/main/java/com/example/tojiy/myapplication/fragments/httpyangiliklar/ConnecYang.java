...
public class ConnecYang extends AsyncTask<String, Void, String> {

    private Context contxt;
    private RecyclerView rv;
    private String login_url = UNVERSALCLASS.url+"yangiliklar.php";
    private String urlphp;

    public ConnecYang(Context ctx, RecyclerView rv) {
        contxt = ctx;
        this.rv = rv;
    }
    ...
    protected String doInBackground(String... params) {
        ...
        if (type.equals("buarssaioii123yuklash")) {
...
//        Toast.makeText(contxt, "" + result, Toast.LENGTH_SHORT).show();
        ...
        DatYang datYang = new DatYang(contxt, rv, result);
        datYang.execute();
